    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (VSout f) : SV_Target
            {
                ...
                {
                    float hairHeight = SAMPLE_TEXTURE2D_ARRAY(_HairTex, sampler_HairTex, offsetUV, f.layer - 1).r;
        ...
        Pass
        {
            ...
            half4 fragShadow(Varyings f) : SV_Target
            {
                if (f.layer != 0)
                {
                    float hairHeight = SAMPLE_TEXTURE2D_ARRAY(_HairTex, sampler_HairTex, f.uv, f.layer - 1).r;
