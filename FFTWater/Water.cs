...
public class Water : MonoBehaviour
{
    ...
    void GetReflectionRT()
    {
        ...
        //Vector3 clipPos = viewMatrix.MultiplyPoint(planePos);
        //Vector3 clipNormal = viewMatrix.MultiplyVector(planeNormal);
        //float d = -Vector3.Dot(clipPos, clipNormal);
        //Vector4 clipWaterPlane = new Vector4(clipNormal.x, clipNormal.y, clipNormal.z, d);

        //Matrix4x4 newObliqueMatrix = reflectionCamera.CalculateObliqueMatrix(clipWaterPlane);
        //reflectionCamera.projectionMatrix = newObliqueMatrix;
        ///
    ...
    void Update()
    {
        ...
        mat.SetFloat("_DisturbanceCoe", disturbanceCoe);
